...
var Trade = /*#__PURE__*/ (function () {
  ...
  Trade.fromRoutes = /*#__PURE__*/ (function () {
    var _fromRoutes = /*#__PURE__*/ _asyncToGenerator(
      /*#__PURE__*/ runtime_1.mark(function _callee(v2Routes, v3Routes, tradeType) {
...
var SwapRouter = /*#__PURE__*/ (function () {
  ...
  SwapRouter.swapAndAddCallParameters = function swapAndAddCallParameters(
    ...
    if (tokenOutApprovalType !== ApprovalTypes.NOT_REQUIRED)
      calldatas.push(ApproveAndCall.encodeApprove(tokenOut, tokenOutApprovalType)) // encode NFTManager add liquidity

    calldatas.push(
      ApproveAndCall.encodeCallPositionManager([
        v3Sdk.NonfungiblePositionManager.addCallParameters(position, addLiquidityOptions).calldata,
      ])
